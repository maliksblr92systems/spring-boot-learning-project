...
public class AppUserDetailsService implements UserDetailsService {
    ...
    @Override
    public CustomUserDetail loadUserByUsername(String idAsString) throws UsernameNotFoundException {
        Integer id = Integer.parseInt(idAsString);
        AppUserModel appUser = appUserRepository.findById(id).orElseThrow(() -> {
            throw ApiException.unAuthenticated("idAsString");
        });
        ...
        userDetails.setUsername(String.valueOf(appUser.getId()));
