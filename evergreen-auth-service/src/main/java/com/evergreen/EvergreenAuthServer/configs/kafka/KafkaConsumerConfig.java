...
public class KafkaConsumerConfig {
    ...
    // Object>> kafkaCompleteRealtimeListenerContainer(ConsumerFactory<String,
    ...
    // final ConsumerFactory<String, Object> factoryProps = new
    ...
    // partitions.forEach(tp -> consumer.commitSync(Collections.singletonMap(tp, new
